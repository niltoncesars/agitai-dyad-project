...
export const events = [
  {
    ...
    description: "O maior festival de música do Brasil com atrações internacionais e nacionais.",
    category: "Música",
    city_id: "1",
    city_name: "São Paulo",
  ...
  },
  {
    ...
    description: "Festival de música eletrônica na praia de Copacabana.",
    category: "Música",
    city_id: "2",
  ...
  },
  {
    ...
    description: "Conferência de tecnologia e inovação com palestrantes nacionais e internacionais.",
    category: "Tecnologia",
    city_id: "3",
  ...
  },
  {
    ...
    description: "Celebração da culinária baiana com chefs renomados.",
  ...
  },
  {
    ...
    description: "Corrida de rua tradicional que reúne milhares de atletas.",
    category: "Esportes",
    city_id: "1",
    city_name: "São Paulo",
  ...
  },
  {
    ...
    description: "Mostra de arte contemporânea com artistas brasileiros e internacionais.",
    category: "Arte & Cultura",
    city_id: "6",
    city_name: "Porto Alegre",
    address: "Museu de Arte do Rio Grande do Sul",
    latitude: -30.0277,
    longitude: -51.2287,
    date: "2024-06-15",
    time: "14:00",
  ...
  },
  {
    ...
    description: "Evento corporativo sobre sustentabilidade e inovação nos negócios.",
    category: "Negócios",
    city_id: "1",
    city_name: "São Paulo",
  ...
  },
  {
    ...
    description: "Mostra de cinema com filmes nacionais e internacionais.",
    category: "Arte & Cultura",
    city_id: "5",
    city_name: "Curitiba",
    address: "Teatro Guaíra",
    latitude: -25.4284,
    longitude: -49.2733,
    date: "2024-07-20",
    time: "19:00",
